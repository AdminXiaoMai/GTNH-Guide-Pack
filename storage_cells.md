...
| 存储元件 | 可容纳数量（使用1类型） | 可容纳数量（最大种类） | 耗电（AE/t） |
| --- | ---: | ---: | ---: |
| <ItemLink id="appliedenergistics2:item.ItemBasicStorageCell.1k" scale="4" />            |       8,128 |      4,160 |         5 |
| <ItemLink id="appliedenergistics2:item.ItemBasicStorageCell.4k" scale="4" />            |      32,512 |     16,640 |        10 |
| <ItemLink id="appliedenergistics2:item.ItemBasicStorageCell.16k" scale="4" />           |     130,048 |     66,560 |        15 |
| <ItemLink id="appliedenergistics2:item.ItemBasicStorageCell.64k" scale="4" />           |     520,192 |    266,240 |        20 |
| <ItemLink id="appliedenergistics2:item.ItemAdvancedStorageCell.256k" scale="4" />       |   2,080,768 |  1,064,960 |        25 |
| <ItemLink id="appliedenergistics2:item.ItemAdvancedStorageCell.1024k" scale="4" />      |   8,323,072 |  4,259,840 |        30 |
| <ItemLink id="appliedenergistics2:item.ItemAdvancedStorageCell.4096k" scale="4" />      |  33,292,288 | 17,039,360 |        35 |
| <ItemLink id="appliedenergistics2:item.ItemAdvancedStorageCell.16384k" scale="4" />     | 133,169,152 | 68,157,440 |        40 |
| <ItemLink id="appliedenergistics2:item.ItemExtremeStorageCell.Container" scale="4" />   |     524,224 |          - |        20 |
| <ItemLink id="appliedenergistics2:item.ItemExtremeStorageCell.Quantum" scale="4" />     |       1.07G |          - |    10,000 |
| <ItemLink id="appliedenergistics2:item.ItemExtremeStorageCell.Singularity" scale="4" /> |       4.61E |          - |   150,000 |
| <ItemLink id="appliedenergistics2:item.ItemExtremeStorageCell.Universe" scale="4" />    |       4.61E |      4.61E | 6,000,000 |

---

| 流体存储元件 | 可容纳mB（使用1类型） | 可容纳mB（最大种类） | 耗电（AE/t） |
| --- | ---: | ---: | ---: |
| <ItemLink id="ae2fc:fluid_storage1" scale="4" />            |      2,080,768 |      2,015,232 |         5 |
| <ItemLink id="ae2fc:fluid_storage4" scale="4" />            |      8,372,224 |      8,060,928 |        10 |
| <ItemLink id="ae2fc:fluid_storage16" scale="4" />           |     33,538,048 |     32,243,712 |        15 |
| <ItemLink id="ae2fc:fluid_storage64" scale="4" />           |    134,201,344 |    128,974,848 |        20 |
| <ItemLink id="ae2fc:fluid_storage256" scale="4" />          |    536,854,528 |    515,899,392 |        25 |
| <ItemLink id="ae2fc:fluid_storage1024" scale="4" />         |  2,147,467,264 |  2,063,597,568 |        30 |
| <ItemLink id="ae2fc:fluid_storage4096" scale="4" />         |  8,589,918,208 |  8,254,390,272 |        35 |
| <ItemLink id="ae2fc:fluid_storage16384" scale="4" />        | 34,359,721,984 | 33,017,561,088 |        40 |
| <ItemLink id="ae2fc:fluid_storage.quantum" scale="4" />     |           275G |              - |        45 |
| <ItemLink id="ae2fc:fluid_storage.singularity" scale="4" /> |          4.61E |              - |        50 |
| <ItemLink id="ae2fc:fluid_storage.Universe" scale="4" />    |          9.22E |          9.22E | 6,000,000 |

---

| 源质存储元件 |类型| 可容纳源质（无类型惩罚） | 耗电（AE/t） |
| --- | ---: | ---: | ---: |
| <ItemLink id="thaumicenergistics:storage.essentia" scale="4" />   | 12 |      2,048 |   5 |
| <ItemLink id="thaumicenergistics:storage.essentia:1" scale="4" /> | 12 |      8,192 |  10 |
| <ItemLink id="thaumicenergistics:storage.essentia:2" scale="4" /> | 12 |     32,768 |  15 |
| <ItemLink id="thaumicenergistics:storage.essentia:3" scale="4" /> | 12 |    131,072 |  20 |
| <ItemLink id="thaumicenergistics:storage.essentia:5" scale="4" /> | 24 |    524,288 |  25 |
| <ItemLink id="thaumicenergistics:storage.essentia:6" scale="4" /> | 36 |  2,097,152 |  30 |
| <ItemLink id="thaumicenergistics:storage.essentia:7" scale="4" /> | 48 |  8,388,608 |  35 |
| <ItemLink id="thaumicenergistics:storage.essentia:8" scale="4" /> | 60 | 33,554,432 |  40 |
| <ItemLink id="thaumicenergistics:storage.essentia:9" scale="4" /> |  1 |       268M |  80 |
| <ItemLink id="thaumicenergistics:storage.essentia:4" scale="4" /> |  1 |      4.61E | 160 |
...
只支持 <ItemLink id="appliedenergistics2:item.ItemMultiMaterial:29" /> <ItemLink id="appliedenergistics2:item.ItemMultiMaterial:31" />  <ItemLink id="appliedenergistics2:item.ItemMultiMaterial:55" /> <ItemLink id="appliedenergistics2:item.ItemMultiMaterial:64" /> 。
...
相反，它们可以作为无限的物品或液体来源和销毁点，用于存放你根据 <ItemLink id="appliedenergistics2:tile.BlockCellWorkbench" /> 分区设置的物品或流体。
