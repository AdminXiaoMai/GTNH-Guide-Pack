...
* <ItemLink id="appliedenergistics2:tile.BlockInterface" />（1）处于默认配置并装有相应<ItemLink id="appliedenergistics2:item.ItemEncodedUltimatePattern" />。其也同时为<ItemLink id="appliedenergistics2:tile.BlockCharger" />提供[能量](../ae2-mechanics/energy.md)，类似[线缆](../items-blocks/cables.md)。
