...
如[自动合成](../ae2-mechanics/autocrafting.md)中所说，自动合成规划算法无法处理首要输出同时是输入的配方。例如，它无法处理复制<ItemLink id="witchery:ingredient:130" />的配方。

解决方案之一便是将<ItemLink id="appliedenergistics2:item.ItemMultiPart:280" />用作[样板](../items-blocks/patterns.md)。
