...
需注意，此设施使用了<ItemLink id="appliedenergistics2:tile.BlockInterface" />，也即需与你的[自动合成](../ae2-mechanics/autocrafting.md)设施配合使用。
...
此设施可与[充能器自动化](charger-automation.md)配合使用以生产<ItemLink id="appliedenergistics2:item.ItemMultiMaterial:1" />。
