...
storage](../ae2-mechanics/import-export-storage.md) and pushes them into the attached container.
...
It is a [cable subpart](../ae2-mechanics/cables-subparts.md).
...
* <ItemLink id="appliedenergistics2:item.ItemMultiMaterial:53" /> requests [autocrafting](../ae2-mechanics/autocrafting.md), with options to use stored items first or always craft new ones.
