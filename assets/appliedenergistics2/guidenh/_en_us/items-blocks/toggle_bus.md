...
A cable subpart that can toggle its connection state using redstone, allowing a section of an [ME Network](../ae2-mechanics/me-network-connections.md) to be disconnected. The inverted variant provides the opposite behavior. Toggling can cause the network to reboot and recalculate connected devices.
