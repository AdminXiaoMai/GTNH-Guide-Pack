...
The I/O Port rapidly fills or empties [storage cells](storage_cells.md) from [network storage](../ae2-mechanics/import-export-storage.md). It can be rotated with a <ItemLink id="appliedenergistics2:item.ToolCertusQuartzWrench" />.
