...
Crafting CPUs manage crafting requests and jobs. They store intermediate products while multi-step crafting jobs are in progress, and affect the maximum size of jobs and, to some degree, how quickly they complete. See [autocrafting](../ae2-mechanics/autocrafting.md) for more details.
